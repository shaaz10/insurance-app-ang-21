...
@Component({
  ...
  template: `
    <header class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50 sticky top-0 z-50 shadow-sm dark:shadow-gray-900/20 transition-all duration-300 supports-[backdrop-filter]:bg-opacity-80">
