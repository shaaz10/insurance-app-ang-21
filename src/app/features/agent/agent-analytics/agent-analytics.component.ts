    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header class="mb-8 animate-fade-in-down">
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-2">Insights into your sales, customer growth, and policy distribution.</p>
        </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-fade-in-up">
          <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div class="text-2xl font-bold text-gray-900 dark:text-white">$124,500</div>
            <div class="flex items-center mt-2 text-sm text-green-600 dark:text-green-400">
          ...
          <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Policies Sold</h3>
            ...
            <div class="text-2xl font-bold text-gray-900 dark:text-white">458</div>
            <div class="flex items-center mt-2 text-sm text-green-600 dark:text-green-400">
              <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
          ...
          <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Claims Processed</h3>
           ...
           <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div class="flex items-center mt-2 text-sm text-yellow-600 dark:text-yellow-400">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 animate-fade-in" style="animation-delay: 0.1s;">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Monthly Revenue Overview</h3>
          ...
          <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 animate-fade-in" style="animation-delay: 0.2s;">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Policy Distribution</h3>
            <div class="relative h-80 flex justify-center">
                <canvas #policyDistChart></canvas>
            </div>
          </div>
        </div>

        <!-- Recent Conversion Bar Chart -->
         <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 animate-fade-in" style="animation-delay: 0.3s;">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-6">Lead vs Conversion</h3>
            <div class="relative h-80">
